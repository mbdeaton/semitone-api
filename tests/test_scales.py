...
class TestScales(unittest.TestCase):
    ...
    def test_major_scale_c_sharp(self):
        r = self.client.get("/scales/major/Csharp")
        self.assertEqual(r.status_code, 200)
        body = r.json()
        self.assertEqual(body["scale_type"], "major")
        self.assertEqual(body["root"], "C#")
    ...
    def test_major_scale_lowercase_c(self):
        r = self.client.get("/scales/major/c")
        self.assertEqual(r.status_code, 200)
        body = r.json()
        self.assertEqual(body["scale_type"], "major")
    ...
    def test_major_scale_lowercase_csharp(self):
        r = self.client.get("/scales/major/csharp")
        self.assertEqual(r.status_code, 200)
        body = r.json()
        self.assertEqual(body["scale_type"], "major")
    ...
    def test_minor_scale_uppercase_bflat(self):
        r = self.client.get("/scales/minor/BFLAT")
        self.assertEqual(r.status_code, 200)
        body = r.json()
        self.assertEqual(body["scale_type"], "minor")
        self.assertEqual(body["root"], "Bb")
        self.assertGreater(len(body["tones"]), 0)
